...
<div class="row mb-2">
  <div class="col-sm-6">
    <h6 class="m-0 text-dark">Edit Unit of Measurement</h6>
  </div>
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
      <li class="breadcrumb-item text-sm"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item text-sm"><a href="{{ route('master-data.unit.index') }}">UOM</a></li>
      <li class="breadcrumb-item active text-sm">Edit</li>
    </ol>
  </div>
</div>
