...
<div class="container-fluid">
  ...
  <div class="card card-primary card-outline">
    ...
    <form action="{{ route('itemmaster.store') }}" method="POST">
      ...
      <div class="card-body">
        <!-- Stock Type (Hidden) -->
        <input type="hidden" name="stock_type" value="{{ request('type', 'inventory') }}">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('item_number') is-invalid @enderror" id="item_number"
                name="item_number" value="{{ old('item_number') }}" required>
              @error('item_number')
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <textarea class="form-control @error('item_description') is-invalid @enderror" id="item_description"
                name="item_description" rows="2">{{ old('item_description') }}</textarea>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control @error('uom_id') is-invalid @enderror" id="uom_id" name="uom_id" required>
                ...
                @foreach($uoms as $uom)
                <option value="{{ $uom->uom_id }}" {{ old('uom_id')==$uom->uom_id ? 'selected' : '' }}>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control @error('second_uom') is-invalid @enderror" id="second_uom" name="second_uom">
                ...
                @foreach($uoms as $uom)
                <option value="{{ $uom->uom_id }}" {{ old('second_uom')==$uom->uom_id ? 'selected' : '' }}>
                  {{ $uom->uom_code }} - {{ $uom->uom_desc }}
                </option>
                @endforeach
              </select>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control @error('spq_ctn') is-invalid @enderror" id="spq_ctn"
                name="spq_ctn" value="{{ old('spq_ctn') }}">
              @error('spq_ctn')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control @error('spq_item') is-invalid @enderror" id="spq_item"
                name="spq_item" value="{{ old('spq_item') }}">
              @error('spq_item')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" step="0.01" class="form-control @error('spq_weight') is-invalid @enderror"
                id="spq_weight" name="spq_weight" value="{{ old('spq_weight') }}">
              @error('spq_weight')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" step="0.01" class="form-control @error('m3_pallet') is-invalid @enderror"
                id="m3_pallet" name="m3_pallet" value="{{ old('m3_pallet') }}">
              @error('m3_pallet')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control @error('spq_pallet') is-invalid @enderror" id="spq_pallet"
                name="spq_pallet" value="{{ old('spq_pallet') }}">
              @error('spq_pallet')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control @error('item_cat_id') is-invalid @enderror" id="item_cat_id"
                ...
                <option value="{{ $cat->item_cat_id }}" {{ old('item_cat_id')==$cat->item_cat_id ? 'selected' : '' }}>
                  {{ $cat->item_cat_name }}
                </option>
                @endforeach
              </select>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" step="0.01" class="form-control @error('standard_price') is-invalid @enderror"
                  id="standard_price" name="standard_price" value="{{ old('standard_price') }}" required>
