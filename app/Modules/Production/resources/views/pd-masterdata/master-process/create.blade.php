    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                ...
                <form action="{{ route('production.master-process.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="process_name" id="process_name"
                                        ...
                                        value="{{ old('process_name') }}" required placeholder="Enter process name">
                                    @error('process_name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="process_desc" id="process_desc" class="form-control @error('process_desc') is-invalid @enderror"
                                        rows="4" placeholder="Enter process description">{{ old('process_desc') }}</textarea>
                                    @error('process_desc')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
