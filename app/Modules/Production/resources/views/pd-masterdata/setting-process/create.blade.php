...
<section class="content">
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <form action="{{ route('setting-process.store') }}" method="POST" id="routing-form">
        @csrf
        <div class="card-body">
          <!-- Header Information -->
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('routing_name') is-invalid @enderror" id="routing_name"
                  name="routing_name" placeholder="Enter Process Name" value="{{ old('routing_name') }}" required>
                @error('routing_name')
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('routing_rmk') is-invalid @enderror" id="routing_rmk"
                  name="routing_rmk" placeholder="Enter Description" value="{{ old('routing_rmk') }}">
                @error('routing_rmk')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control @error('part_no') is-invalid @enderror" id="part_no"
                    name="part_no" placeholder="Auto Fill" value="{{ old('part_no') }}" readonly>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('part_name') is-invalid @enderror" id="part_name"
                  name="part_name" placeholder="Product Name" value="{{ old('part_name') }}" readonly>
                @error('part_name')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('part_desc') is-invalid @enderror" id="part_desc"
                  name="part_desc" placeholder="UOM" value="{{ old('part_desc') }}" readonly>
                @error('part_desc')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
            ...
            <table class="table table-bordered table-striped text-sm" id="process-table">
              ...
              <tbody id="process-tbody">
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm process-desc" name="process_desc[]" readonly>
                  </td>
                  <td>
                    <input type="number" class="form-control form-control-sm" name="cycle_time_second[]" value="0"
                      min="0" required>
                  </td>
