...
@section('title', 'Create Settings Process')
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Settings Process</h3>
                ...
                <form action="{{ route('production.setting-process.store') }}" method="POST" id="routing-form">
                    @csrf
                    <div class="card-body">
                        <!-- Header Information -->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('routing_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('routing_name') }}" required>
                                    @error('routing_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('routing_active_date', date('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('routing_status') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('routing_status', '1') == '1' ? 'selected' : '' }}>
                                            Active</option>
                                        <option value="0" {{ old('routing_status') == '0' ? 'selected' : '' }}>
                                            Inactive</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('part_desc') is-invalid @enderror"
                                        id="part_desc" name="part_desc" placeholder="UOM" value="{{ old('part_desc') }}"
                                        readonly>
                                    @error('part_desc')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm"
                                                name="cycle_time_second[]" value="0" min="0" required>
                                        </td>
                    ...
                    <div class="card-footer text-right">
                        <button type="button" class="btn btn-default mr-2" id="btn-reset">
        ...
        `;
                ...
                $('#btn-reset').click(function() {
                    if (confirm('Are you sure you want to reset the form?')) {
                        $('#routing-form')[0].reset();
                        $('#process-tbody').html($('#process-tbody tr:first').clone());
                        rowCount = 1;
                        updateRowNumbers();
                    }
                });
