            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('production.setting-process.index') }}" class="btn btn-tool" title="Back to List">
                            <i class="fas fa-times"></i>
                        </a>
                    </div>
                </div>

                <form action="{{ route('production.setting-process.update', $routing->routing_id) }}" method="POST"
                    id="routing-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="routing_name">Setting Process Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('routing_name') is-invalid @enderror"
                                        id="routing_name" name="routing_name" placeholder="Enter Process Name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('routing_rmk') is-invalid @enderror"
                                        id="routing_rmk" name="routing_rmk" placeholder="Enter Description"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        class="form-control @error('routing_active_date') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('routing_status') is-invalid @enderror"
                                        id="routing_status" name="routing_status" required>
                                        <option value="1"
                                            {{ old('routing_status', $routing->routing_status) == '1' ? 'selected' : '' }}>
                                            Active</option>
                                        <option value="0"
                                            {{ old('routing_status', $routing->routing_status) == '0' ? 'selected' : '' }}>
                                            Inactive</option>
                                    </select>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('part_no') is-invalid @enderror"
                                            id="part_no" name="part_no" placeholder="Auto Fill"
                                            value="{{ old('part_no', $routing->part_no) }}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('part_name') is-invalid @enderror"
                                        id="part_name" name="part_name" placeholder="Product Name"
                                        value="{{ old('part_name', $routing->part_name) }}" readonly>
                                    @error('part_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('part_desc') is-invalid @enderror"
                                        id="part_desc" name="part_desc" placeholder="UOM"
                                        value="{{ old('part_desc', $routing->part_desc) }}" readonly>
                                    @error('part_desc')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <tbody id="process-tbody">
                                    @foreach ($routing->details as $index => $detail)
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control form-control-sm process-select"
                                                    ...
                                                    @foreach ($processes as $process)
                                                        <option value="{{ $process->proces_id }}"
                                                            ...
                                                            {{ $detail->process_id == $process->proces_id ? 'selected' : '' }}>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm process-desc"
                                                    name="process_desc[]" value="{{ $detail->process_desc }}" readonly>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control form-control-sm"
                                                    name="cycle_time_second[]" value="{{ $detail->cycle_time_second }}"
                                                    min="0" required>
                                            </td>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('production.setting-process.index') }}" class="btn btn-default mr-2">
