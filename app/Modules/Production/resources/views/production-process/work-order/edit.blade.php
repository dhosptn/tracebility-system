    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                ...
                <form action="{{ route('production.work-order.update', $wo->wo_id) }}" method="POST" id="wo-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if (session('error'))
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('wo_date') is-invalid @enderror"
                                        id="wo_date" name="wo_date"
                                        value="{{ old('wo_date', $wo->wo_date ? $wo->wo_date->format('Y-m-d') : '') }}"
                                        required>
                                    @error('wo_date')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('prod_date') is-invalid @enderror"
                                        id="prod_date" name="prod_date"
                                        value="{{ old('prod_date', $wo->prod_date ? $wo->prod_date->format('Y-m-d') : '') }}"
                                        required>
                                    @error('prod_date')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="wo_qty" placeholder="WO Qty" value="{{ old('wo_qty', $wo->wo_qty) }}"
                                        required>
                                    @error('wo_qty')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('part_no') is-invalid @enderror"
                                            ...
                                            value="{{ old('part_no', $wo->part_no) }}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="part_name" name="part_name"
                                        placeholder="Masukkan nama produk" value="{{ old('part_name', $wo->part_name) }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="uom" name="uom"
                                        placeholder="Otomatis terisi" value="{{ old('uom', $wo->uom_id) }}" readonly>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select class="form-control" id="lot_id" name="lot_id">
                                        ...
                                        @foreach ($lots as $lot)
                                            <option value="{{ $lot->lot_id }}"
                                                {{ old('lot_id', $wo->lot_id) == $lot->lot_id ? 'selected' : '' }}>
                                                {{ $lot->lot_no }}</option>
                                        @endforeach
                                    </select>
                                    @error('lot_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="wo_rmk" name="wo_rmk"
                                        placeholder="Remarks" value="{{ old('wo_rmk', $wo->wo_rmk) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="wo_status" name="wo_status">
                                        <option value="Release" {{ $wo->wo_status == 'Release' ? 'selected' : '' }}>
                                            Release</option>
                                        <option value="Draft" {{ $wo->wo_status == 'Draft' ? 'selected' : '' }}>Draft
                                        </option>
                                        <option value="On Process" {{ $wo->wo_status == 'On Process' ? 'selected' : '' }}>
                                            On Process</option>
                                        <option value="Built" {{ $wo->wo_status == 'Built' ? 'selected' : '' }}>Built
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('production.work-order.index') }}" class="btn btn-default mr-2">
