...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <a href="{{ route('wo.index') }}" class="btn btn-secondary mr-2">
          <i class="fas fa-arrow-left"></i> Back to Work Order List
        </a>
        <a href="{{ route('wo.report', $wo->wo_id) }}" class="btn btn-primary">
    ...
    <div class="card card-primary card-outline">
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              <label class="text-muted font-weight-normal">WO No <span class="text-danger">*</span></label>
              <input type="text" class="form-control" value="{{ $wo->wo_no }}" readonly>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label class="text-muted font-weight-normal">WO Date <span class="text-danger">*</span></label>
              <input type="text" class="form-control" value="{{ $wo->wo_date ? $wo->wo_date->format('d/m/Y') : '-' }}"
                readonly>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label class="text-muted font-weight-normal">Production Date <span class="text-danger">*</span></label>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label class="text-muted font-weight-normal">WO Qty <span class="text-danger">*</span></label>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label class="text-muted font-weight-normal">Part Number <span class="text-danger">*</span></label>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label class="text-muted font-weight-normal">Status <span class="text-danger">*</span></label>
          ...
          <table class="table table-bordered table-sm text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td rowspan="2" class="align-middle text-center">0</td> {{-- Placeholder for Remain Qty --}}
                <td rowspan="2" class="align-middle text-center"></td> {{-- Placeholder for Start Date --}}
                <td rowspan="2" class="align-middle text-center"></td> {{-- Placeholder for Last Prod Dt --}}
