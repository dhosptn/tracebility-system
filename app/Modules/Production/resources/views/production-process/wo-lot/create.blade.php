            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('production.lot_number.index') }}" class="btn btn-tool" title="Back to List">
                            <i class="fas fa-times"></i>
                        </a>
                    </div>
                </div>

                <form action="{{ route('production.lot_number.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lot_no" id="lot_no"
                                        ...
                                        value="{{ old('lot_no') }}" readonly
                                        placeholder="Lot Number will be generated automatically">
                                    <small class="text-muted">Format: LOT + YYYYMMDD + Sequence (e.g.,
                                        LOT202512060001)</small>
                                    @error('lot_no')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="qty_per_lot" id="qty_per_lot"
                                        class="form-control @error('qty_per_lot') is-invalid @enderror"
                                        value="{{ old('qty_per_lot') }}" placeholder="Enter quantity per lot">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_desc" id="item_desc"
                                        ...
                                        value="{{ old('item_desc') }}" placeholder="Enter item description">
                                    @error('item_desc')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="charge_no" id="charge_no"
                                        class="form-control @error('charge_no') is-invalid @enderror"
                                        value="{{ old('charge_no') }}" placeholder="Enter charge number">
                                    @error('charge_no')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('production.lot_number.index') }}" class="btn btn-default mr-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchNextLotNumber(date) {
                ...
                $.ajax({
                    url: "{{ route('production.lot_number.next') }}",
                    type: "GET",
                    data: {
                        date: date
                    },
