                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('production.lot_number.index') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form id="editLotForm" method="POST"
                            action="{{ route('production.lot_number.update', $lot->lot_id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('lot_no') is-invalid @enderror"
                                            id="lot_no" name="lot_no" value="{{ old('lot_no', $lot->lot_no) }}"
                                            required>
                                        @error('lot_no')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('lot_date') is-invalid @enderror"
                                            id="lot_date" name="lot_date"
                                            value="{{ old('lot_date', $lot->lot_date->format('Y-m-d')) }}" required>
                                        @error('lot_date')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('qty_per_lot') is-invalid @enderror" id="qty_per_lot"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('charge_no') is-invalid @enderror"
                                            id="charge_no" name="charge_no" value="{{ old('charge_no', $lot->charge_no) }}">
                                        @error('charge_no')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('item_desc') is-invalid @enderror" id="item_desc" name="item_desc" rows="2">{{ old('item_desc', $lot->item_desc) }}</textarea>
                                        @error('item_desc')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('production.lot_number.index') }}" class="btn btn-secondary">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response && response.success) {
                            ...
                            "{{ route('production.lot_number.index') }}";
                        } else {
